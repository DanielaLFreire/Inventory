# pages/2_📊_Modelos_Volumétricos.py - VERSÃO COMPLETA E CORRIGIDA
"""
...
CORRIGIDO: Keys duplicadas, melhorias de UX
"""
...
def mostrar_downloads_volumetricos(resultados, predicoes, volumes_arvore, sufixo=""):
    ...
    with col1:
        ...
        st.download_button(
            ...
            "text/csv",
            key=gerar_key_unica(f"download_ranking_vol{sufixo}")  # KEY ÚNICA
        )
    ...
    with col2:
        ...
        st.download_button(
            ...
            "text/csv",
            key=gerar_key_unica(f"download_dados_vol{sufixo}")  # KEY ÚNICA
        )
    ...
    with col3:
        ...
        st.download_button(
            ...
            "text/markdown",
            key=gerar_key_unica(f"download_relatorio_vol{sufixo}")  # KEY ÚNICA
        )
